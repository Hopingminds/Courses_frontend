...
const ManageJobsFilter = () => {
    ...
    const [postedBy, setPostedBy] = useState(true);
                ...
                <div className="w-full py-6 border-b">
                    ...
                    <div className="flex flex-wrap py-2">
                        {selectedFilters.map((filter) => (
                            ...
                            >
                                <p className="font-pop text-gray-700 font-medium text-[12px]">{filter}</p>
                                <RxCross2
                                    fontSize={'1rem'}
                    ...
                    <div className="flex flex-col py-2">
                        <label htmlFor="activejobs" className="flex justify-between py-2">
                            <div className="flex items-center gap-x-2">
                                ...
                                />
                                <label htmlFor="activejobs" className="select-none text-[13px] text-gray-600">
                                    Active Jobs
                                </label>
                            </div>
                            <div>
                        ...
                        <label htmlFor="closedjobs" className="flex justify-between py-2">
                            <div className="flex items-center gap-x-2">
                                ...
                                />
                                <label htmlFor="closedjobs" className="select-none text-[13px] text-gray-600">
                                    Closed Jobs
                                </label>
                            </div>
                            <div>
