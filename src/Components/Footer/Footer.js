...
const Footer = () => {
    ...
    return (
        <>
            <div className='flex flex-col gap-14 bg-[#E2FFF1] py-10 mt-12 xsm:gap-8 xsm:mt-8'>
                <div className='flex  justify-between px-[5%] xsm:pl-[5%] xsm:flex xsm:flex-col xsm:gap-8'>
                    ...
                    <div className='flex flex-col gap-4 xsm:gap-2  '>
                        ...
                        <div className='flex flex-col gap-4 xsm:gap-1'>
                            ...
                            <p className='text-[#555555] text-[16px] font-nu xsm:text-[8px]'>Privacy Policy</p>
                            <p className='text-[#555555] text-[16px] font-nu xsm:text-[8px]'>Terms and Conditions</p>
                        </div>
                    </div>
                    <div className='flex flex-col gap-4 xsm:gap-2  '>
