            ...
            <div className='flex flex-col gap-14  pt-10 pb-4 xsm:gap-8 add_gradient'>
                <div className='flex  justify-between px-[5%] xsm:pl-[5%] xsm:flex xsm:flex-col xsm:gap-8'>
                    <div className='flex flex-col gap-8 w-[220px] xsm:gap-2 xsm:w-[90%]'>
                        ...
                        <p className='text-white text-[16px] font-nu text-balance w-full xsm:text-[10px] md:text-[12px]'>Empower your future with interactive courses tailored to your goals. Join our dynamic eLearning community and unlock your potential today!</p>
                    </div>
                    <div className='flex flex-col gap-4 xsm:gap-2  '>
                        <p className='text-white text-[20px] font-nu font-semibold xsm:text-[10px]'>GET HELP</p>
                    ...
                    <div className='flex flex-col gap-4 xsm:gap-2 ' onClick={Top} >
                        ...
                        <div className='flex flex-col gap-4 xsm:gap-1'>
                            ...
                            <Link to='/course?category=Finance' className='text-white text-[16px] font-nu xsm:text-[8px]'>Finance</Link>
                            <Link to='/course?category=Full Stack Development' className='text-white text-[16px] font-nu xsm:text-[8px]'>Full Stack Development</Link>
                            <Link to='/course?category=AI' className='text-white text-[16px] font-nu xsm:text-[8px]'>AI/ML</Link>
                            <Link to='/course?category=Cyber Security' className='text-white text-[16px] font-nu xsm:text-[8px]'>Cyber Security</Link>
                            <Link to='/course?category=Electric Vehicle Design' className='text-white text-[16px] font-nu xsm:text-[8px]'>Electric Vehicle Design</Link>
                        </div>
                    </div>
                    <div className='flex flex-col gap-4 xsm:gap-2  '>
                ...
                <div className='flex flex-row gap-2 items-center justify-center xsm:gap-1'>
                    ...
                    <p className='text-white text-[14px] font-nu font-semibold xsm:text-[10px]'>KATINA SKILLS PRIVATE LIMITED 2023</p>
                </div>
            </div>
        </>
    )
