    ...
    <>
      <div className="flex flex-row  justify-between pt-0 px-[5%] pb-32 xsm:px-[5%] xsm:pb-8 xsm:gap-4">
        ...
        <div className="flex flex-col gap-4 w-[50%] xsm:gap-2">
          ...
          <div className="flex flex-col gap-4 text-[#696984] text-[18px] font-poppins xsm:text-[6px] xsm:gap-0 md:text-[12px]">
            <p className="">
        ...
        <div className="relative w-[40%]">
          <div className="relative ">
            <img
              ...
              className="w-[350px] h-[420px]  rounded-3xl xsm:rounded-md xsm:w-[95px] xsm:h-[120px] md:w-[240px] md:h-[280px]"
            />
                ...
                >
                  ...
                  <div className="flex flex-col justify-between px-4 py-3 xsm:px-2 xsm:py-2 xsm:gap-1 md:gap-2">
                    ...
                    <div className="flex flex-row justify-between items-center ">
                      <p className="text-[#5F5F7E] text-[16px] font-nu font-semibold xsm:text-[4px] md:text-[10px]">
                        {/* Gloria Rose */}
                        {testimonial.author}
                      </p>
                      <div className="flex flex-col gap-1  xsm:gap-0">
                        <div className="flex justify-center items-center">
                          {[...Array(testimonial.stars)].map((star, index) => (
                            <svg viewBox="0 0 24 24" className="h-5 w-5 xsm:h-2 xsm:w-2 md:h-3 md:w-3" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* arrrow */}
          <div
            className="w-[70px] h-[70px] absolute bg-[#ffffff] rounded-full right-[20%] top-[42%] flex justify-center items-center text-3xl text-[#1EA4CE] font-bold cursor-pointer xsm:w-[20px] xsm:h-[20px] xsm:right-[28%] md:w-[40px] md:h-[40px]"
