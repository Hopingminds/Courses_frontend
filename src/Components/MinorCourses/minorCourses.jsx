      ...
      <div className="bg_clippath h-[60vh] w-full grid place-items-center ">
        ...
        <div className="text-[16px] px-[5vw] pb-8 text-white">
          <p>
            ...
            amet eos eligendi quisquam harum, vitae a deserunt et. Dolor at
            itaque illum sint qui amet veniam. Perferendis quos qui quo
            accusamus voluptates porro maxime aperiam omnis quidem quisquam
            autem tempora facilis architecto necessitatibus temporibus ut quis
            incidunt nemo, harum repellat cupiditate nisi vero? Cum eaque
            ratione tempore saepe fuga explicabo ipsam praesentium, ducimus quam
            quia eum.
          </p>
        </div>
      </div>
