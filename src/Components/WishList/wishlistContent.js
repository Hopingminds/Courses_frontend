            ...
            <div className='wishlist-content'>
                <div className='wishlist-box'>
                    ...
                    <div className='wishlist-box-content'>
                        ...
                        <div className='wishlist-box-row3'>
                            <div className='wishlist-box-row3-clock'>
                                <img src="../Icons/clockfilled.svg" alt="clock"></img>
                                <p> 2 Weeks</p>
                            </div>
                            <div className='wishlist-box-row3-hat'>
                                <img src="../Icons/hat.svg" alt="hat"></img>
                                <p> 156 Students</p>
                            </div>
                            <div className='wishlist-box-row3-level'>
                                <img src="../Icons/barchartgreen.svg" alt="bar-chart"></img>
                                <p> All levels</p>
                            </div>
                            <div className='wishlist-box-row3-files'>
                                <img src="../Icons/files.svg" alt="files"></img>
                                <p> 20 Lessons</p>
                            </div>
                        </div>
                        <div className='hr-line'><hr/></div>
                        <div className='wishlist-box-row4'>
                            <div className='wishlist-box-row4-price'>
                                <p>$29.0 <span>Free</span></p>
                            </div>
                            <div className='wishlist-box-row4-more'>
                                <p>View More</p>
                            </div>
                        </div>
                    </div>
