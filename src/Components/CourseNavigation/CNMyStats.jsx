		...
		<div className='bg-[#E2FFF1] min-h-[425px] rounded-b-[20px] px-[30px] py-[24px]  flex flex-col items-center gap-2 '>
			...
			<div className="flex justify-around items-center w-full">
				...
				<AnimatedProgressProvider
					valueStart={0}
					valueEnd={calculateAverageProgress(completedLessons || 0,completedAssignments || 0)}
					duration={1.4}
				...
				>
					...
					return (
						...
						value={calculateAverageProgress(completedLessons || 0,completedAssignments || 0)}
						strokeWidth={3}
						styles={buildStyles({
							pathColor: "#FB67CA",
							trailColor: "#E9EBF3",
				...
				<div className="flex flex-col items-start w-[30%] xsm:flex-col xsm:mt-0 xsm:space-x-0 xsm:gap-3 xsm:items-start md:mt-6 md:space-x-8">
					<div className="flex justify-between items-center w-full">
						...
						<p className="font-nu font-semibold text-[20px] xsm:text-[10px] md:text-[14px]">{calculateAverageProgress(completedLessons,completedAssignments)}%</p>
					</div>
					<div className="flex justify-between items-center w-full">
						<div className="flex space-x-2 items-center md:space-x-1">
						<img
						...
						<p className="font-nu font-semibold text-[20px] xsm:text-[10px] md:text-[14px]">{percentageAssignment}%</p>
					</div>
					<div className="flex justify-between items-center w-full">
						<div className="flex space-x-2 items-center md:space-x-1">
						<img
