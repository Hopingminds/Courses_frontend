...
const NewModal = ({ handleModalOpen,datas,type }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-700 bg-opacity-20 backdrop-blur-lg">
            <div className="relative p-4 w-full max-w-4xl max-h-[75vh] bg-[#E2FFF1] rounded-lg shadow dark:bg-gray-700 h-auto xsm:w-[90%] xsm:p-2">
                {/* Modal header */}
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 gap-4">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button
                            ...
                            className="absolute top-4 right-4 font-bold text-white bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-2xl w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white xsm:text-lg xsm:top-2"
                        ...
                        >
                            ...
                            <div className="bg-white px-4 py-3 grid grid-cols-3 gap-3 items-center justify-between xsm:grid-cols-2">
                                {module?.allData?.map((lesson, index) => (
                                        ...
                                        <div className="bg-[#F5F5F5] flex flex-col px-[2rem] py-[2rem] items-start rounded-md xsm:p-[1rem]">
                                            {type === "Project" && <>
