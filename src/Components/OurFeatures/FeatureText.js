...
const FeatureTexts = [
  <>
    <p className="text-[26px] text-white font-pop font-semibold xsm:text-[8px] md:text-[20px]">
    ...
    <div className="flex flex-col gap-4 mt-2 xsm:gap-1 xsm:mt-0">
      <div className="flex flex-row gap-10 justify-between items-center xsm:gap-2 md:gap-5">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[90px] h-[50px] flex justify-center items-center xsm:w-[40px] xsm:h-[16px] md:w-[52px] md:h-[24px]">
          <img src={Img1} className="w-[28px] h-[26px] xsm:w-[8px] xsm:h-[8px] md:w-[12px] md:h-[12px]" />
        </div>
        <p className="text-white text-[16px] font-pop xsm:text-[6px] md:text-[10px]">
      ...
      <div className="flex flex-row gap-10 items-center xsm:gap-2 md:gap-5">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[95px] h-[50px] flex justify-center items-center xsm:w-[44px] xsm:h-[16px] md:w-[54px] md:h-[24px]">
          <img src={Img2} className="w-[30px] h-[26px] xsm:w-[8px] xsm:h-[8px] md:w-[12px] md:h-[12px]" />
        </div>
        <p className="text-white text-[16px] font-pop xsm:text-[6px] md:text-[10px]">
      ...
      <div className="flex flex-row gap-10 items-center xsm:gap-2 md:gap-5">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[95px] h-[50px] flex justify-center items-center xsm:w-[40px] xsm:h-[16px] md:w-[52px] md:h-[24px]">
