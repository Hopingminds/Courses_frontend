...
const FeatureTexts = [
  <>
    <p className="text-[34px] text-[#000000] font-poppins font-semibold">
      A{" "}
    ...
    <div className="flex flex-col gap-4 mt-2">
      <div className="flex flex-row gap-10 justify-between items-center">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[90px] h-[50px] flex justify-center items-center">
          <img src={Img1} className="w-[26px] h-[26px]" />
        </div>
        <p className="text-[#696984] text-[20px] font-poppins">
          Teachers don’t get lost in the grid view and have a dedicated Podium
          space.
        </p>
      </div>
      <div className="flex flex-row gap-10 items-center">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[70px] h-[50px] flex justify-center items-center">
      ...
      <div className="flex flex-row gap-10 items-center">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[75px] h-[50px] flex justify-center items-center">
  ...
  <>
    ...
    <div className="flex flex-col gap-4">
      <p className="text-[#696984] text-[20px] font-poppins leading-8">
