...
const FeatureTexts = [
  <>
    ...
    <div className="flex flex-col gap-4 mt-2 xsm:gap-2 xsm:mt-0">
      <div className="flex flex-row gap-10 justify-between items-center xsm:gap-2 md:gap-6">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[90px] h-[50px] flex justify-center items-center xsm:w-[40px] xsm:h-[18px] md:w-[42px] md:h-[28px]">
          <img src={Img1} className="w-[26px] h-[26px] xsm:w-[10px] xsm:h-[10px] md:w-[14px] md:h-[14px]" />
        </div>
      ...
      <div className="flex flex-row gap-10 items-center xsm:gap-2 md:gap-6">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[70px] h-[50px] flex justify-center items-center xsm:w-[30px] xsm:h-[18px] md:w-[36px] md:h-[28px]">
          <img src={Img2} className="w-[28px] h-[26px] xsm:w-[10px] xsm:h-[10px] md:w-[14px] md:h-[14px]" />
        </div>
        <p className="text-white text-[20px] font-pop xsm:text-[6px] md:text-[10px]">
      ...
      <div className="flex flex-row gap-10 items-center xsm:gap-2 md:gap-6">
        <div className="bg-[#ffffff] shadow-xl rounded-full w-[75px] h-[50px] flex justify-center items-center xsm:w-[35px] xsm:h-[18px] md:w-[38px] md:h-[28px]">
          <img src={Img3} className="w-[30px] h-[26px] xsm:w-[10px] xsm:h-[10px]md:w-[14px] md:h-[14px]" />
        </div>
        <p className="text-white text-[20px] font-pop xsm:text-[6px] md:text-[10px]">
