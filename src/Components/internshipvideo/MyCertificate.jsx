...
export default function InternshipCertificate(props) {
    ...
    return (
        <div className="px-[5%] my-[3%] flex space-y-8 justify-between xsm:flex-col-reverse xsm:mt-3">
            <div className="flex flex-col w-[90%] justify-between xsm:w-[100%] md:w-[95%] md:gap-3">
...

                {
                    courses?.map((item, ind) => {
                        ...
                        return (<>
                        {
                            ...
                            {!flag ? <div className="text-center  w-full font-bold text-2xl xsm:text-sm xsm:text-center">You didn't complete any course</div> : ''}
