...
export default function InternshipCourseDrawer({ isOpen, setIsOpen, component }) {
    ...
    >
      <section
        ...
        className={`absolute bg-gray-100 shadow-xl transition-transform duration-500 ease-in-out transform rounded-xl
          ...
          lg:w-[70vw] lg:h-[80vh] lg:top-[11vh] lg:left-[18vw]
          xl:w-[60vw] xl:h-[80vh] xl:top-[11vh] xl:left-[22vw]
          2xl:w-[50vw] 2xl:h-[80vh] 2xl:top-[11vh] 2xl:left-[27vw]
        `}
