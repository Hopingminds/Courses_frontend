...
export default function AiExperts() {
  ...
  return (
    <div
      id="experts"
      className="px-[5%] py-[4%] pl-[24%] bg-[#F1F1F1] flex flex-col gap-4"
    >
        ...
        >
          {experts.map((expert, index) => (
            <SplideSlide>
              <div
                key={index}
                className=" bg-[#169f63] flex flex-col items-center py-8 px-10 gap-4 h-[475px]"
              >
                <div className="w-[33%] rounded-full overflow-hidden">
                  <img src={expert.image} alt="" />
                </div>
                <div className="flex flex-col items-center gap-1">
                  <p className="font-mons font-extrabold text-white text-[18px]">
                    {expert.author}
                  </p>
                ...
                <div className="mt-6 ">
                  <p className="font-mons text-white text-[14px] text-center">
                    {expert.text}
                  </p>
                </div>
              </div>
