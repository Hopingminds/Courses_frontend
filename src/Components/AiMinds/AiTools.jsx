...
export default function AiTools() {
  ...
  return (
    <div
      id="tools"
      className=" px-[5%] py-[4%] pl-[24%] flex flex-col gap-2 xsm:px-[2%] xsm:py-[2%] xsm:gap-1"
    >
      <p className="font-mons font-extrabold text-[30px] text-[#169f63] xsm:text-[14px]">
        Lanuguages & Tools You Will Learn
      </p>
      <p className="font-mons font-extrabold text-[20px] text-[#100101] xsm:text-[10px]">
        15+ Programming Languages, Tools and Libraries Covered
      </p>
      {/* Tools cards */}
      <div className="grid grid-cols-4 gap-4 gap-y-6 my-6 xsm:my-2 xsm:gap-y-2 xsm:gap-2">
        {tools.map((tool, index) => (
          ...
          >
            ...
            <p className="font-outfit font-semibold py-2 text-[14px] xsm:text-[7px]">
              {tool.name}
            </p>
          </div>
        ))}
      ...
      <div className="px-[6%] mt-4 xsm:px-[3%] xsm:mt-2">
        ...
        >
          <SplideSlide>
            <img
              className="border border-black rounded-xl xsm:rounded-md xsm:border-[1px]"
              src="../img/chatgpt.png"
