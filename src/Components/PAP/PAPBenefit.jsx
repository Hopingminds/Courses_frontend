      ...
      <div className="flex h-[90vh] justify-around mt-[15vh] place-items-center  ">
        <div className=" h-[80vh] py-[10vh] relative ">
          ...
          {/* <div className="border-[30px] cursor-pointer border-[#615f5f] rounded-full absolute top-[50%] translate-y-[-50%] left-[0%] bg-[#D9D9D9] h-[40vh] aspect-square p-[1rem] grid place-items-center">
            <p className="text-[25px] text-center font-medium">Banefits of Pap</p>
          </div> */}
          ...
          <div onClick={()=>setcontent("Securing your future is our promise. With our 100% Placement Guarantee, embark on your journey knowing we're committed to your success every step of the way.")} className="flex gap-[1rem]  cursor-pointer max-w-[15vw] h-20 border rounded-[3rem] p-2 pr-4 place-items-center absolute top-[5%] right-[0%] bg-black">
