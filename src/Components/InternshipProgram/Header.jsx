        ...
        <div className="text-white flex flex-row flex-wrap xsm:mt-[8vh] gap-4 pb-4 justify-center items-center">
          ...
          >
            ...
            <p className="px-1 opacity-0 group-hover:opacity-100 absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 backdrop-blur-lg transition-opacity duration-300 rounded-xl text-sm">
              Develop a strong foundation through six months of focused
              training, preparing you for real-world challenges.
            </p>
          </div>
          {/* Card 2 */}
          <div
          ...
          >
            ...
            <p className="px-1 opacity-0 group-hover:opacity-100 absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 backdrop-blur-lg transition-opacity duration-300 rounded-xl text-sm">
              Sharpen your analytical and problem-solving skills to stand out in
              corporate environments and interviews.{" "}
            </p>
          </div>
          {/* Card 3 */}
          <div
          ...
          >
            ...
            <p className="px-1 opacity-0 group-hover:opacity-100 absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 backdrop-blur-lg transition-opacity duration-300 rounded-xl text-sm">
              Boost your interpersonal and communication skills to confidently
              navigate your career and workplace interactions.{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="px-1 opacity-0 group-hover:opacity-100 absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-50 backdrop-blur-lg transition-opacity duration-300 rounded-xl text-sm">
              Gain access to job placement opportunities that align with your
              skills and help launch your career path.{" "}
            </p>
          </div>
        </div>
