...
const StudentList = () => {
  ...
  return (
    <div className="relative ">
      <div
        className={`bg-[#F4F4F4] w-full px-[4%] py-[2%]  ${
          showPopup ? "filter blur-sm" : ""
        }`}
      >
        <div className="bg-white  my-[3%] mx-auto py-[3%] rounded-lg xsm:rounded-[20px]  border border-[#80808080]">
          {/* HEADING */}
          ...
          <div>
            {currentItems.map((item, index) => (
              <div key={index} className="px-[3%] pt-[2%]">
                <div className="grid grid-cols-[1.2fr,0.9fr,1fr,1.5fr,1fr,0.5fr] place-content-center items-center xsm:gap-1 border-b border-[#80808080] pb-5">
