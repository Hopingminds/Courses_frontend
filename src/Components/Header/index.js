            ...
            {userDetail?.role !== "subadmin" && (
              <>
                ...
                <Link
                  ...
                  onClick={Top}
                  className={` rounded-full hover:text-[#1DBF73] xsm:text-[12px] sm:text-[10px] md:text-[14px] font-pop  ${
                    location.pathname === "/course" ? " font-bold text-[#1DBF73]" : ""
                  }`}
                >
                  Courses
                </Link>
                <Link
                  ...
                  onClick={Top}
                  className={` rounded-full hover:text-[#1DBF73] xsm:text-[12px] sm:text-[10px] md:text-[14px] font-pop  ${
                    location.pathname === "/internship" ? " font-bold text-[#1DBF73]" : ""
                  }`}
                >
                  Internship
                </Link>
                <Link
                  ...
                  onClick={Top}
                  className={` rounded-full hover:text-[#1DBF73] xsm:text-[12px] sm:text-[10px] md:text-[14px] font-pop ${
                    location.pathname === "/hire-from-us" ? " font-bold text-[#1DBF73]" : ""
                  }`}
                >
                  Hire From Us
                </Link>
                ...
                {userDetail?._id && (
                  <Link
                    to="/learning"
                    className={` rounded-full hover:text-[#1DBF73] xsm:text-[12px] sm:text-[10px] md:text-[14px] font-pop ${
                      location.pathname === "/learning" ? " font-bold text-[#1DBF73]" : ""
                    }`}
                  >
                    My Learning
                  </Link>
