...
const SideBar = () => {
    ...
    return (
        <div className='h-full w-full flex justify-end '>
            <div className='flex flex-col justify-between w-16 h-[75vh] bg-[#1DBF73] mt-10 rounded-full p-2 mr-5 hover:w-full hover:mr-0  hover:h-full hover:rounded-none hover:mt-0 hover:p-0 hover:pt-12 sidebarHover '>
                <div className='flex flex-col gap-1 items-center mt-4 sideBarMenus text-white'>
                    <div onClick={() => navigate('/learning?tab=courses')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
                        <MyCourse className='SidebarmenuIcons invert-0'/>
                        <div className='hidden SideTextshow'>
                            <p className='text-[14px]'>My Courses</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/learning?tab=assignments')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
                        <MyAssignment className='SidebarmenuIcons invert-0'/>
                        <div className='hidden SideTextshow'>
                            <p className='text-[14px]'>Assignment</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/learning?tab=wishlist')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
                        <MyWhishlist className='SidebarmenuIcons invert-0'/>
                        <div className='hidden SideTextshow'>
                            <p className='text-[14px]'>Wishlist</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/learning?tab=certificate')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
                        <MyCertificate className='SidebarmenuIcons invert-0'/>
                        <div className='hidden SideTextshow'>
                            <p className='text-[14px]'>Certification</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/learning?tab=stats')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
                        <MyStats className='SidebarmenuIcons invert-0'/>
                        <div className='hidden SideTextshow'>
                            <p className='text-[14px]'>My Stats</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/learning?tab=job')} className='flex items-center py-2 cursor-pointer sideBarMenu'>
