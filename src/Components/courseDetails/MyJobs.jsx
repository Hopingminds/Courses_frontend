  ...
  return (
    <>
      <div className="px-[5%] my-[3%] flex gap-10 space-y-8 justify-between xsm:flex-col-reverse xsm:mt-3">
        <div
          className={`flex flex-col justify-between xsm:w-[100%] md:w-[95%] md:gap-3 ${
            !jobOpeningData ? "w-full" : "w-[90%]"
          }`}
        >
          {!jobOpeningData ? (
            ...
            return (
              <>
                <div
                  ...
                  key={ind}
                  className="h-[10rem] w-full flex flex-row gap-4 bg-[#E2FFF1] p-4 mt-4 rounded-2xl justify-between shadow-2xl shadow-[#D9D9D9] xsm:p-2 xsm:rounded-lg xsm:h-[10vh] md:mt-0 md:p-3"
                >
