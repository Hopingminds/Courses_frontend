        ...
        <div className="flex flex-col gap-10 xl:gap-12 xsm:gap-6 sm:gap-6">
          ...
          <div className="flex place-content-start">
            {localStorage.getItem("COURSES_USER_TOKEN") ? (
              ...
              <Link
                to="/login"
                className="text-white z-20 text-[16px] font-nu font-bold bg-[#1DBF73] rounded-full py-2 px-10 sm:px-6 sm:py-1 sm:text-[12px] xl:text-[20px] md:text-[14px] md:px-8 xsm:text-[12px] xsm:py-[0.2rem] xsm:px-4"
              >
                Join Now
              </Link>
            )}
