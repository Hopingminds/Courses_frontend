    ...
    return (<>
        ...
        <div className="add_gradient h-[76vh]  w-100% flex font-pop justify-center items-center px-[3%] 2xl:h-[65vh] xsm:h-[70vh] text-white hero mb-20 xsm:mb-0 md:h-[60vh] md:mb-0">
            <div className='w-[40%] h-[70%] items-start 2xl:space-y-10'>
                ...
                <div className='text-[44px] font-semibold leading-[4.0rem] 2xl:leading-[5.5rem] font-pop xsm:text-[15px] xsm:leading-5 md:text-[24px] md:leading-normal'>Education for Everyone, Success on Your Terms: No Cost Until You're Hired</div>
