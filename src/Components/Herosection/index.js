    ...
    <>
      <div className=" bg-gradient-to-l from-[#0F2027] via-[#0B1418] to-[#203A43] w-full flex flex-row justify-between font-pop items-center px-[5%] pt-[1%] pb-[4%] mb-[4%] md:pr-[3%] md:pb-[3%] xsm:pt-5">
        <div className="flex flex-col gap-10 xl:gap-12 xsm:gap-6 xsm:mt-5 sm:gap-6">
          ...
          <div className="text-[20px] leading-10  text-white font-pop text-wrap w-[90%] sm:text-[14px] xl:text-[26px] md:text-[16px] md:leading-6 sm:leading-6 xsm:text-[12px] xsm:leading-6">
              ...
              <div className="flex flex-col-reverse gap-5 md:gap-3 xsm:gap-2">
                ...
                <div className="rounded-[4rem] h-72 w-36 overflow-hidden scale-in-center sm:h-28 sm:w-16 lg:h-64 lg:w-30 md:h-56 md:w-24 md:rounded-[2.3rem] xsm:h-24 xsm:w-12 xsm:rounded-[1.3rem]">
                  <img
                    ...
                    className="h-72 w-36 object-cover object-center md:h-56 md:w-24 xsm:h-24 xsm:w-12 lg:h-64 lg:w-30 sm:h-28 sm:w-16"
                  />
                </div>
              </div>
            </div>
