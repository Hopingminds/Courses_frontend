...
export default function Herosection() {
    ...
    return (<>
        ...
        <div className="add_gradient h-[76vh]  w-100% flex font-pop justify-center items-center px-[3%] 2xl:h-[65vh] xsm:h-[26vh] text-white hero mb-20 xsm:mb-0 md:h-[60vh] md:mb-0">
