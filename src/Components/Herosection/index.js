    ...
    return (<>
        <div className="border bg-[#E2FFF1] h-[87.5vh] hero w-full flex font-pop justify-center items-center px-[3%]">
            <div className='w-[45%] space-y-12'>
                <div className='text-[54px] font-bold w-[90%]'>Studying Online is now much easier</div>
                <div className='font-nu text-[24px] w-[70%]'>TOTC is an interesting platform that will teach you in more an interactive way</div>
                <button className='px-6 py-3 text-white bg-[#1DBF73] rounded-full text-[24px]' onClick={() => navigate('/register')}>Join for free</button>
            </div>
