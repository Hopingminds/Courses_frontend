  ...
  return (
    <div className="thankpage my-5 xsm:mx-2 md:flex md:justify-center md:items-center xsm:flex xsm:justify-center">
      <div className="thank-you">
        ...
        <h1 className="text-[#1DBF73] font-semibold font-pop">
          Assessment Completed Successfully
        </h1>
        <div className="text-center px-20">
          Thank you for participating in Assessment. You will be receiving your
          test results via email within 24 Hrs.
        </div>
