                ...
                <div className='w-[30%]'>
                    <div className='bg-[#00000033] border-2 rounded-xl p-6 text-white flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col gap-1'>
                                <label className='text-[13px] font-medium' htmlFor="pass">Password</label>
                                <input id='pass' className='bg-[#00000033] border-[1px] border-[#808080] rounded-md px-3 py-[6px] text-[#808080] text-[15px]' type="password" placeholder='Enter Your Password' />
                            </div>
                            <div className='flex flex-col gap-1'>
                                <label className='text-[13px] font-medium' htmlFor="study">Field Of Study</label>
                                <input id='study' className='bg-[#00000033] border-[1px] border-[#808080] rounded-md px-3 py-[6px] text-[#808080] text-[15px]' type="text" placeholder='Enter Your Field' />
                            </div>
                            <div className='flex flex-col gap-1'>
                                <label className='text-[13px] font-medium' htmlFor="time">Time Slot</label>
                                <input id='time' className='bg-[#00000033] border-[1px] border-[#808080] rounded-md px-3 py-[6px] text-[#808080] text-[15px]' type="text" placeholder='Enter Your Slot' />
                            </div>
                        </div>
                        <div>
                            <button className='bg-[#1DBF73] border-[1px] border-[#808080] rounded-md py-1 font-int font-medium w-full'>Take Your Test</button>
                        </div>
