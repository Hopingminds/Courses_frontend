        ...
        <div className="grid grid-cols-4 md:mt-8 mt-16 gap-8 xsm:grid-cols-2 xsm:mt-8">
            ...
            <div className=" flex flex-col py-[15%]  relative">
              <div className="flex justify-around items-center gap-1">
                <img
                  alt=""
                  src="/node.png"
                  className="object-contain h-11 w-auto md:w-8 md:h-8 xsm:w-6 xsm:h-6 img-item"
                  style={{
              ...
              <div className="text-[25px] text-[#FFFFFF] text-center mt-5 md:text-[16px] xsm:text-[12px]">
                Backend Developers
              </div>
          ...
          >
            <div className=" flex flex-col py-[15%] ">
              ...
              <div className="text-[25px] text-[#FFFFFF] text-center mt-5 md:text-[16px] md:px-4 xsm:text-[12px]">
                UI/UX Designer
              </div>
              <div className="flex flex-col gap-y-4 text-[#FFFFFF] pl-[5%] mt-3 font-extralight md:text-[12px] md:gap-y-3 xsm:text-[8px] xsm:gap-y-2">
