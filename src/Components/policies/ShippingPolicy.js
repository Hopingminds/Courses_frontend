            ...
            <div className="flex flex-col md:flex-row xl:flex-row lg:flex-row gap-8 relative">
                ...
                >
                    ...
                    <div className="mb-8" ref={contactUsRef}>
                        ...
                        <p className="text-gray-700 mb-2 font-poppins">
                            If you have any questions about these Terms, please contact us at: <a href="mailto:support@hopingminds.com" className="text-blue-500 underline">support@hopingminds.com</a>,<a href='tel:+919193700050'>+919193700050</a>
                        </p>
                    </div>
                </section>
            </div>
