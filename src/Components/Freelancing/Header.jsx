export default function Header({ scrollToFreelancingPage }) {
  return (
    <div className="py-6 pl-[5vw] bg-gradient-to-l from-[#0F2027] via-[#0B1418] to-[#203A43] w-full flex flex-col lg:flex-row justify-between font-pop px-6 lg:px-[10%] h-[80vh] lg:h-[70vh] xsm:h-[60vh]">
      <div className="text-white w-full">
        ...
        <div className="mt-[6vh] lg:mt-[9vh] w-full sm:w-[70vw] md:w-[60vw] lg:w-[40vw] font-pop">
          <p className="text-2xl sm:text-xl md:text-2xl  lg:text-3xl">
            Complete your course and start your freelancing journey with top
            companies.
          </p>
          <button
            className="bg-green-600 hover:bg-green-700 xsm:w-[60%] xsm:mt-5 sm:w-[60%] sm:mt-5 text-white text-base sm:text-lg md:text-xl lg:text-2xl font-pop rounded-full w-[20vw] md:w-[50vw] lg:w-[50vw] h-[7vh] mt-[15vh]"
