...
const CourseCard = ({
  ...
  return (
    ...
    >
      ...
      />:<img
      // style={{ height: "10rem" }}
      className="w-full  rounded-t-xl h-[45%] xsm:h-[45%] md:h-[35%]"
      src={image}
      alt="Course"
    />
      }
      ...
      <div className=" h-[45%] xsm:h-[45%]">
        <div className="px-2 flex justify-between items-center h-[15%] text-[#474747] mt-4">
          <div className="flex items-center gap-2">
              <img src="/lina.png" className="h-8 w-8 bg-[#0000001A] rounded-full xsm:h-4 xsm:w-4 md:h-6 md:w-6" />
              <div className="font-medium font-pop text-[16px] xsm:text-[6px] md:text-[8px]">{firstName} {lastName}</div>
            </div>
        ...
        <div className="px-2 pt-4 flex gap-6 flex-col justify-between h-[85%] xsm:mt-1 xsm:py-1 xsm:px-0 xsm:justify-between xsm:space-y-0 md:py-2 md:mt-0">
          ...
          <div className="flex justify-between items-center ">
            <div className="flex space-x-2 items-center xsm:space-x-1">
              <Design className="h-4 w-4 text-[#808080] xsm:h-2 xsm:w-2 md:w-3 md:h-3"/>
              <span className="text-[14px] xsm:text-[6px] text-[#808080] md:text-[8px]">{category}</span>
            </div>
            <div className=" flex items-center space-x-2 xsm:space-x-1 md:mt-1">
              <Clock className="h-4 w-4 text-[#808080] xsm:h-2 xsm:w-2 md:w-3 md:h-3"/>
              <p className="text-[14px] xsm:text-[6px] text-[#808080] md:text-[8px]"> {duration}</p>
            </div>
