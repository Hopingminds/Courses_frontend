...
const BuildCV = () => {
  return (
    <div
      ...
      className="w-full flex flex-col gap-16 justify-center items-center text-white font-pop font-semibold py-[4%] mt-20 md:gap-12 sm:gap-10 xsm:gap-6 xsm:py-[5%]"
    >
      <div className="flex flex-col gap-8 justify-center items-center w-[70%] md:gap-6 sm:gap-5 xsm:w-[80%] xsm:gap-4">
        <p className="text-[36px] text-center md:text-[30px] md:leading-tight xsm:text-[14px] xsm:leading-tighter sm:text-[18px]">
          Create your professional Resume with our designs
        </p>
        <p className="text-[20px] text-center md:text-[14px] md:leading-tight xsm:text-[8px] sm:text-[12px]">
