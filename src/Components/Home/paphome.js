...
const PapHome = () => {
    ...
    return (
        <div id='pap' className='px-[10%] py-20 flex flex-col items-center xsm:px-[5%] sm:px-[5%] md:px-[5%] xsm:pb-3 md:pb-5 xsm:py-5' >
            ...
            <button className='px-6 py-3 text-white bg-[#1DBF73] rounded-full xsm:text-[20px] xsm:py-1 xsm:px-6 sm:text-[20px] sm:py-2 sm:px-3 md:text-[12px] md:py-2 md:px-4 font-pop xsm:mt-0' onClick={() => navigate('/pap')}>Find Out ?</button>
        </div>
    )
}
