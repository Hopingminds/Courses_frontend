...
const PapHome = () => {
    ...
    return (
        <div id='pap' className='px-20 flex flex-col items-center xsm:px-[5%] md:px-[5%]' >
            ...
            <p className='text-center text-[#696984] text-[20px] font-pop mt-4 xsm:text-[7px] md:text-[10px]'>Hoping Minds is democratising education with a unique Pay After Placement (PAP) Model. <br /> PAP allows you to study the course of your choice at ₹0 upfront fee with our PAP Agreement.</p>
            <div className='flex justify-between my-10 space-x-10 xsm:gap-x-2 xsm:space-x-0 xsm:my-4 md:space-x-8 md:my-6'>
                <div className='bg-[#F0FFF7] py-5 px-8 flex flex-col items-center gap-2 shadow-md shadow-[#0000001C] rounded-lg xsm:px-2 w-[90%]'>
