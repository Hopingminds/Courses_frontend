        ...
        <div id='pap' className='px-[10%] py-20 flex flex-col items-center xsm:px-[5%] sm:px-[5%] md:px-[5%] xsm:pb-3 md:pb-5 xsm:py-5' >
            ...
            <div className='flex justify-between my-10 space-x-14 xsm:space-y-5 xsm:flex-col xsm:space-x-0 xsm:my-4 sm:space-x-5 sm:my-5 md:space-x-8 md:my-6 lg:space-x-10'>
                <div className='bg-[#E2FFF1] pt-10 p-8 flex flex-col items-center gap-4 shadow-md shadow-[#0000001C] rounded-lg xsm:px-2 xsm:py-3 sm:px-3 sm:py-4 w-[90%] xsm:w-full'>
                    <img className='xsm:w-[50px] xsm:h-auto sm:w-[30px] sm:h-[30px] md:w-[35px] md:h-[25px] lg:w-[40px] lg:h-[40px] w-[50px] h-[50px]' src='../Icons/pap1.svg' />
                ...
                <div className='bg-[#E2FFF1] pt-10 p-8 flex flex-col items-center gap-4 shadow-md shadow-[#0000001C] rounded-lg xsm:px-2 xsm:py-3 sm:px-3 sm:py-4 w-[90%] xsm:w-full'>
                    <img className='xsm:w-[50px] xsm:h-auto sm:w-[30px] sm:h-[30px] md:w-[35px] md:h-[25px] lg:w-[40px] lg:h-[40px] w-[50px] h-[50px]' src='../Icons/pap2.svg' />
                ...
                <div className='bg-[#E2FFF1] pt-10 p-8 flex flex-col items-center gap-4 shadow-md shadow-[#0000001C] rounded-lg xsm:px-2 xsm:py-3 sm:px-3 sm:py-4 w-[90%] xsm:w-full'>
                    <img className='xsm:w-[50px] xsm:h-auto sm:w-[30px] sm:h-[30px] md:w-[35px] md:h-[25px] lg:w-[40px] lg:h-[40px] w-[50px] h-[50px]' src='../Icons/pap3.svg' />
            ...
            <button className='px-6 py-3 text-white bg-[#1DBF73] rounded-full xsm:text-[20px] xsm:py-1 xsm:px-6 sm:text-[20px] sm:py-2 sm:px-3 md:text-[12px] md:py-2 md:px-4 font-pop xsm:mt-0' onClick={() => navigate('/pap')}>Click to explore ?</button>
        </div>
    )
}
