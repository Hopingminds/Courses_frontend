...
const PapHome = () => {
    ...
    return (
        <div id='pap' className='px-20 flex flex-col items-center xsm:px-[5%] md:px-[5%]' >
            ...
            <button className='px-6 py-3 text-white bg-[#1DBF73] rounded-full xsm:text-[8px] xsm:py-1 xsm:px-3 md:text-[12px] md:py-2 md:px-4 font-pop' onClick={() => navigate('/pap')}>Kick Start</button>
        </div>
    )
}
