        ...
        <div className='SC-container font-pop'>
            ...
            <div className='flex justify-between items-start mt-[10px] lg:flex-col lg:items-center h-auto  px-[3%] xsm:flex-col xsm:h-auto xsm:gap-8 xsm:mb-10 md:h-auto md:my-10'>
                                ...
                                <p className='font-mons text-[0.8vw] 2xl:text-[14px]'><span className='text-[#555555]'>by</span> Determined-instructure</p>
                                        ...
                                        <div className='flex flex-nowrap justify-between items-center'>
                                            <div className='space-y-2'>
                                                <p className='font-mons text-[1.5vw] font-semibold  2xl:text-[18px] xsm:text-[10px]'>{item.course.title}</p>
                                                <p className='text-[#696984] text-sm xsm:hidden'>{item.course.overview.slice(0, 70)}.. </p>

                                            </div>
                                            <div>
                                                <p onClick={() => Removecart(item.course._id)} className='cursor-pointer font-mons text-[1vw] 2xl:text-[16px]  mt-[1vw] text-black font-semibold xsm:text-[7px]'>Remove</p>
                                            </div>
                                        </div>
                                        <div className='flex flex-nowrap justify-between'>
                                            <div className='flex gap-6 my-[0.5vw] w-[60%] 2xl:w-full 2xl:text-[11px] xsm:gap-2'>
                                                <div className='flex items-center'>
                                                    ...
                                                    <p className='font-mons text-[0.8vw] 2xl:text-[14px] font-normal text-[#555555] xsm:text-[6px]'> {item.course.duration}</p>
                                                </div>
                                                <div className='flex items-center'>
                                                    <img className='w-[1.6vw] mr-[0.1vw] 2xl:w-[13px]' src="../Icons/hat.svg" alt="hat"></img>
                                                    <p className='font-mons text-[0.8vw] 2xl:text-[14px] font-normal text-[#555555] xsm:text-[6px]'> {item.course.enrollments / 1000}k Students</p>
                                                </div>
                                                {/* <div className='flex items-center'>
                                        ...
                                        <p className='font-mons text-[0.8vw] 2xl:text-[14px] font-normal text-[#555555]'> All levels</p>
                                                ...
                                                <div className='flex items-center'>
                                                    ...
                                                    <p className='font-mons text-[0.8vw] 2xl:text-[14px] font-normal text-[#555555] xsm:text-[6px]'> {item.course.total_lessons} Lessons</p>
                                                </div>
                                            </div>
                                            <div>
                                                <p className='font-mons text-[1vw] 2xl:text-[16px]   text-black font-semibold xsm:text-[7px]'>Save For Later</p>
                                            </div>
                                        </div>
                                        <div className='flex justify-end flex-nowrap'>
                                            <p className='font-mons text-[1vw]  mt-[0.6vw] text-black font-semibold 2xl:text-[16px] xsm:text-[7px]'>Move To Wishlist</p>
                                        </div>
                                        ...
                                        <div className='flex justify-between mt-[0.8vw] flex-wrap'>
                                            ...
                                            <div>
                                                <p className='font-Inter text-[1.2vw] font-semibold text-[black] 2xl:text-[20px] xsm:text-[8px]'>₹{item.course.base_price}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {Data?.length > 0 && <div className='w-[20%] h-max flex flex-col justify-around space-y-4 font-pop xsm:w-[100%] xsm:px-3 xsm:space-y-1'>
                    ...
                    <div>
                        <p className='font-mons text-[1vw] text-[#1DBF73] font-semibold 2xl:text-[16px] xsm:text-[8px]'>Including all the taxes</p>
                    </div>
