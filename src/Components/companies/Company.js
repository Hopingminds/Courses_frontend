    ...
    <div className='container'>
        <div>
            <div className='heading'>
                <h2>150+ Comapnies are waiting for you</h2>
            </div>
            <div className='paragraph'>
                <p className='content-para'>We'll help you get hired. Our team will work with you throughout the program and after graduation to help you embellish your portfolio, practice interviewing and land a job that enhances your skills and accelerates your growth.</p>
            </div>
        </div>
