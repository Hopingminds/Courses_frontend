...
const ScheduledAssignmentsCard = ({setCreateAssignment}) => {
    return (
        <div className='border border-[#E6E6E6] rounded-xl px-4 py-2 text-[#3C3C3C] font-int flex flex-col gap-2'>
            ...
            <button onClick={() => setCreateAssignment('create')} className='bg-black text-white rounded py-2 text-[11px] mt-3'>
                Join Now
            </button>
        </div>
    )
...
export default ScheduledAssignmentsCard