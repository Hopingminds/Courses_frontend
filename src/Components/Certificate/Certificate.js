...
const Certificate = () => {
  return (
    <>
      <div className="flex flex-row justify-between items-center bg-[#F0FFF7] gap-10 px-[5%] py-16 xsm:py-6 xsm:gap-4 md:py-10">
        <div className="w-[65%] h-[60vh] xsm:h-[18vh] md:h-[16vh] md:w-[50%]">
        ...
        <div className="flex flex-col space-y-3 w-[70%] xsm:gap-2 xsm:space-y-0">
          <p className="text-[42px] text-[#000000] font-pop font-extrabold xsm:text-[12px] md:text-[28px]">
            {" "}
            <span className="text-[#1DBF73]"> Certification </span> Provided In Partnership With N.S.D.C
          </p>
          <p className="text-[#000000] text-[18px] font-nu text-justify leading-8 tracking-wider xsm:text-[7px] xsm:leading-3 xsm:text-balance md:text-[10px] md:leading-5">
            NSDC Certification is a prestigious recognition for students who
            have completed accredited skill-based training programs. <span className="text-[#000000] text-[20px] font-nu xsm:hidden md:text-[10px]"> It
