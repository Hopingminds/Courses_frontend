  ...
  return (
    <>
      <div className="flex flex-row justify-between items-center bg-[#F0FFF7] gap-10 px-[5%] py-14 xsm:py-6 xsm:gap-4 md:py-10">
        <div className="w-[65%] h-[450px] xsm:h-[14vh] sm:h-[200px] md:h-[220px] md:w-[50%] lg:h-[300px] lg:w-[50%]">
        ...
        <div className="flex flex-col space-y-3 w-[70%] xsm:gap-2 xsm:space-y-0">
          <p className="text-[36px] text-[#000000] font-pop font-semibold xsm:text-[12px] sm:text-[20px] md:text-[28px]">
            {" "}
            <span className="text-[#1DBF73]"> Certification </span> Provided In Partnership With N.S.D.C
          </p>
          <p className="text-[#000000] text-[20px] font-pop text-justify leading-10 xsm:text-[7px] sm:text-[10px] xsm:leading-3 xsm:text-balance sm:leading-4 md:text-[10px] md:leading-5 lg:text-[18px] lg:leading-6">
            NSDC Certification is a prestigious recognition for students who
            have completed accredited skill-based training programs. <span className="text-[#000000] text-[20px] font-pop xsm:hidden sm:text-[10px] md:text-[10px] lg:text-[18px] lg:leading-6"> It
