  ...
  return (
    <>
      <div className="flex flex-row justify-between items-center bg-[#F0FFF7] gap-10 px-[5%] py-16 xsm:py-6 xsm:gap-4">
        <div className="w-[60%] h-[52vh] xsm:h-[18vh]">
        ...
        <div className="flex flex-col space-y-3 w-[70%] xsm:gap-2 xsm:space-y-0">
          <p className="text-[42px] text-[#000000] font-pop font-extrabold xsm:text-[12px]">
            {" "}
            <span className="text-[#1DBF73]"> Certification </span> By The
            N.S.D.C
          </p>
          <p className="text-[#000000] text-[18px] font-nu text-justify leading-10 tracking-wider xsm:text-[7px] xsm:leading-3 xsm:text-balance">
